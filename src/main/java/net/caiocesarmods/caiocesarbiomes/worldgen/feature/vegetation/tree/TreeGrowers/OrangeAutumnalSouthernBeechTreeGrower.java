...
public class OrangeAutumnalSouthernBeechTreeGrower extends AbstractTreeGrower {
    /**
     * @param pRandom
     * @param pHasFlowers
    ...
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource pRandom, boolean pHasFlowers) {
        if (pRandom.nextInt(10) == 0) {
            return ModTreeFeatures.WINDSWEPT_AUTUMNAL_ORANGE_SOUTHERN_BEECH_KEY;
        } else {
            return ModTreeFeatures.AUTUMNAL_ORANGE_SOUTHERN_BEECH_KEY;
        }
    }
}
