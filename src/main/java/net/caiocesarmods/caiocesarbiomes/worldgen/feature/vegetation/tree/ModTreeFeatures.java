...
public class ModTreeFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        //Jungle Figs
        FeatureUtils.register(context, WEEPING_FIG_BIG_KEY, Feature.TREE,
        ...
        FeatureUtils.register(context, WEEPING_FIG_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.JUNGLE_FIG_LOG.get()),
                new StraightTrunkPlacer(4, 2, 0),
                BlockStateProvider.simple(ModBlocks.WEEPING_FIG_LEAVES.get()),
                new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3),
                new TwoLayersFeatureSize(1, 0, 1)).build());
        FeatureUtils.register(context,INDIAN_LAUREL_BIG_KEY, Feature.TREE,
                new TreeConfiguration.TreeConfigurationBuilder(
                        BlockStateProvider.simple(ModBlocks.JUNGLE_FIG_LOG.get()),
                        new DarkOakTrunkPlacer(6, 2, 1),
        ...
        FeatureUtils.register(context, INDIAN_LAUREL_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.JUNGLE_FIG_LOG.get()),
                new StraightTrunkPlacer(4, 2, 0),
                BlockStateProvider.simple(ModBlocks.INDIAN_LAUREL_LEAVES.get()),
                new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3),
        ...
        //Fig Tree
        FeatureUtils.register(context, FIG_KEY, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(
        ...
        //Mediterranean Oaks
        FeatureUtils.register(context, HOLM_OAK_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.HOLM_OAK_LOG.get()),
                new StraightTrunkPlacer(6, 2, 0),
                BlockStateProvider.simple(ModBlocks.HOLM_OAK_LEAVES.get()),
                new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3),
                new TwoLayersFeatureSize(1, 0, 1)).build());
        FeatureUtils.register(context, FANCY_HOLM_OAK_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.HOLM_OAK_LOG.get()),
                new FancyTrunkPlacer(3, 11, 0),
                BlockStateProvider.simple(ModBlocks.HOLM_OAK_LEAVES.get()),
                new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(4), 4),
                new TwoLayersFeatureSize(0, 0, 0,OptionalInt.of(4))).build());
        FeatureUtils.register(context, CORK_OAK_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.CORK_OAK_LOG.get()),
                new StraightTrunkPlacer(6, 2, 0),
                BlockStateProvider.simple(ModBlocks.CORK_OAK_LEAVES.get()),
                new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3),
                new TwoLayersFeatureSize(1, 0, 1)).build());
        FeatureUtils.register(context, FANCY_CORK_OAK_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.CORK_OAK_LOG.get()),
                new FancyTrunkPlacer(3, 11, 0),
                BlockStateProvider.simple(ModBlocks.CORK_OAK_LEAVES.get()),
                new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(4), 4),
        ...
        //Oak Shrubs
        FeatureUtils.register(context, HOLM_OAK_SHRUB_KEY, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.HOLM_OAK_LOG.get()),
                new StraightTrunkPlacer(1, 0, 0),
                BlockStateProvider.simple(ModBlocks.HOLM_OAK_LEAVES.get()),
                new BushFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 2),
                new TwoLayersFeatureSize(0, 0, 0))).build());
        FeatureUtils.register(context, CORK_OAK_SHRUB_KEY, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.CORK_OAK_LOG.get()),
                new StraightTrunkPlacer(1, 0, 0),
                BlockStateProvider.simple(ModBlocks.CORK_OAK_LEAVES.get()),
                new BushFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 2),
                new TwoLayersFeatureSize(0, 0, 0))).build());
        FeatureUtils.register(context, OAK_SHRUB_KEY, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(
        ...
        FeatureUtils.register(context, PLANE_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.PLANE_LOG.get()),
                new StraightTrunkPlacer(6, 2, 0),
                BlockStateProvider.simple(ModBlocks.PLANE_LEAVES.get()),
                new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3),
                new TwoLayersFeatureSize(1, 0, 1)).build());
        FeatureUtils.register(context, FANCY_PLANE_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.PLANE_LOG.get()),
                new FancyTrunkPlacer(3, 11, 0),
                BlockStateProvider.simple(ModBlocks.PLANE_LEAVES.get()),
                new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(4), 4),
