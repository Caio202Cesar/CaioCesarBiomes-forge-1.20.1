...
public class JapaneseMapleGroveBiome {
    public static final ResourceKey<Biome> JAPANESE_MAPLE_GROVE = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(CaioCesarBiomesMod.MOD_ID, "japanese_maple_grove"));

    public static void bootstrap(BootstapContext<Biome> context) {
        context.register(JAPANESE_MAPLE_GROVE, japaneseMapleGroveBiome(context));
    }
    ...
    public static Biome japaneseMapleGroveBiome(BootstapContext<Biome> context) {
