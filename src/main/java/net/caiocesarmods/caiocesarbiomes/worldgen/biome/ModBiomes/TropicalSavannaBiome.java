...
public class TropicalSavannaBiome {
    public static final ResourceKey<Biome> TROPICAL_SAVANNA = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(CaioCesarBiomesMod.MOD_ID, "tropical_savanna"));

    public static void bootstrap(BootstapContext<Biome> context) {
        context.register(TROPICAL_SAVANNA, tropicalSavanna(context));
    }
    ...
    public static Biome tropicalSavanna(BootstapContext<Biome> context) {
