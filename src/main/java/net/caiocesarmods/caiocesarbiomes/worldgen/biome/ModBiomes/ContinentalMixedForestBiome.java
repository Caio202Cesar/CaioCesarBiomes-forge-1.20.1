...
public class ContinentalMixedForestBiome {
    public static final ResourceKey<Biome> CONTINENTAL_MIXED_FOREST = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(CaioCesarBiomesMod.MOD_ID, "continental_mixed_forest"));

    public static void bootstrap(BootstapContext<Biome> context) {
        context.register(CONTINENTAL_MIXED_FOREST, continentalMixedForestBiome(context));
    }
    ...
    public static Biome continentalMixedForestBiome(BootstapContext<Biome> context) {
