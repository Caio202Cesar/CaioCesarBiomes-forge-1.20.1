...
public class TemperateBadlandsBiome {
    public static final ResourceKey<Biome> TEMPERATE_BADLANDS = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(CaioCesarBiomesMod.MOD_ID, "temperate_badlands"));

    public static void bootstrap(BootstapContext<Biome> context) {
        context.register(TEMPERATE_BADLANDS, temperateBadlandsBiome(context));
    }
    ...
    public static Biome temperateBadlandsBiome(BootstapContext<Biome> context) {
