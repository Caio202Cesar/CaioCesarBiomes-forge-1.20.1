...
public class TussockTundraBiome {
    public static final ResourceKey<Biome> TUSSOCK_TUNDRA = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(CaioCesarBiomesMod.MOD_ID, "tussock_tundra"));

    public static void bootstrap(BootstapContext<Biome> context) {
        context.register(TUSSOCK_TUNDRA, tussockTundraBiome(context));
    }
    ...
    public static Biome tussockTundraBiome(BootstapContext<Biome> context) {
